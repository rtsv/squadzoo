...
function WordChainPage() {
  ...
  useEffect(() => {
    ...
    if (roomCode) {
      // This will be handled by WordChain component
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Play Word Chain online with friends! Create word chains by connecting words that start with the last letter of the previous word. Free multiplayer brain game for 2-12 players." />
        <meta name="keywords" content="word chain game, word chain online, multiplayer word game, vocabulary game, brain game, word game online, educational game" />
